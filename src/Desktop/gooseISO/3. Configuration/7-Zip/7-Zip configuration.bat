@echo off
title 7-Zip configuration script
...
if exist "C:\Program Files\7-Zip\" (
	...
	echo[
	echo 7-Zip does not seem to be installed in the default location.
	echo You may have 7-Zip installed via Scoop. If so, use the other script.
