# ALL CREDITS GO TO https://github.com/gunnarhaslinger/Windows-Defender-Exploit-Guard-Configuration
# THIS SCRIPT IS NOT MADE BY ME (HE3ALS) AND IS MADE BY @gunnarhaslinger (on GitHub)
# ----------------------------------------------------------------------------------------------------------
